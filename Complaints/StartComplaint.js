    ...
    <View
      ...
      <View
        ...
        <View
          ...
          {startTime && <Text style={{ fontWeight: "bold", paddingBottom: 1 }}>Start Details</Text>}
        ...
        <View
          ...
          {endTime && <Text style={{ fontWeight: "bold", paddingBottom: 1 }}>End Details</Text>}
          ...
          <>
            <View>
              <TouchableOpacity
                ...
                <Text style={{ color: 'black', fontWeight: "bold", alignItems: "center" }}>Add Parts</Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity
              style={{
              ...
              <Text style={{ color: 'black', fontWeight: "bold" }}> <Image
      ...
      <View style={{ width: "100%", alignItems: "center", justifyContent: "flex-end" }}>
        ...
        <TouchableOpacity
          ...
          <Text style={{ color: 'black', fontWeight: "bold" }}>Submit Complaint</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
